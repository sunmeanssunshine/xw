...
//                "%5B%7B%22lastUpdateTime%22%3A%222011-10-28+9%3A39%3A41%22%2C%22smsList%22%3A%5B%7B%22liveState%22%3A%221";
        String str = new String(Files.readAllBytes(Paths.get("1.txt")));
        System.out.println("原长度：" + str.length());
        String gzipStr = new String(GZIPUtils.compress(str));
        System.out.println("压缩后字符串：" + gzipStr.length());
        //System.out.println("解压缩后字符串：" + StringUtils.newStringUtf8(GZIPUtils.uncompress(GZIPUtils.compress(str))));
        System.out.println(str.equals(GZIPUtils.uncompressToString(GZIPUtils.compress(str))));
    }
}
